...
namespace relation {
    ...
    struct Dippr100 {
        ...
        constexpr explicit Dippr100():
            ...
            c4(0.0f)
        {}
        constexpr Dippr100(const Dippr100& f):
            c1(f.c1),
            c2(f.c2),
            c3(f.c3),
            c4(f.c4)
        ...
        constexpr Dippr100& operator*=(const float scalar)
        {
            c1 *= scalar;
            return *this;
        }
    ...
    constexpr Dippr100 operator*(const Dippr100 relation, const float scalar)
    {
        return Dippr100(relation.c1 * scalar, relation.c2, relation.c3, relation.c4);
    }
    constexpr Dippr100 operator*(const float scalar, const Dippr100 relation)
    {
        return Dippr100(relation.c1 * scalar, relation.c2, relation.c3, relation.c4);
    }
    constexpr Dippr100 operator/(const Dippr100 relation, const float scalar)
    ...
    constexpr Dippr100 operator-(const Dippr100 relation)
    {
        return Dippr100(relation.c1 * -1.0f, relation.c2, relation.c3, relation.c4);
    }


    constexpr Dippr100 compose(Dippr100 f, const math::Scaling<float> g)
    {
        return Dippr100(
    ...
    */
    ...
    struct Dippr114 {
        ...
        constexpr explicit Dippr114():
            ...
            c4(0.0f)
        {}
        constexpr Dippr114(const Dippr114& f):
            c1(f.c1),
            c2(f.c2),
            c3(f.c3),
            c4(f.c4)
        ...
        constexpr Dippr114& operator*=(const float scalar)
        {
            c1 *= scalar;
            return *this;
        }
    ...
    constexpr Dippr114 operator*(const Dippr114 relation, const float scalar)
    {
        return Dippr114(relation.c1 * scalar, relation.c2, relation.c3, relation.c4);
    }
    constexpr Dippr114 operator*(const float scalar, const Dippr114 relation)
    {
        return Dippr114(relation.c1 * scalar, relation.c2, relation.c3, relation.c4);
    }
    constexpr Dippr114 operator/(const Dippr114 relation, const float scalar)
    ...
    constexpr Dippr114 operator-(const Dippr114 relation)
    {
        return Dippr114(relation.c1 * -1.0f, relation.c2, relation.c3, relation.c4);
    }
    ...
    using ClampedDippr105 = math::Clamped<float,Dippr100>;
    using ClampedDippr119 = math::Clamped<float,Dippr114>;
    ...
    */
    ...
    public:
        ...
        // zero constructor
        constexpr LiquidHeatCapacityTemperatureRelation():
            dippr105s(),
            dippr119s(),
        ...
        constexpr LiquidHeatCapacityTemperatureRelation(const si::density<double> intercept):
            dippr105s(0),
            dippr119s(0),
        ...
        constexpr LiquidHeatCapacityTemperatureRelation<si::density<double>>& operator=(const LiquidHeatCapacityTemperatureRelation<si::density<double>> other)
        {
        ...
        si::density<double> operator()(const si::temperature<double> temperature) const
        {
            ...
            ClampedDippr105 dippr100;
            ClampedDippr119 dippr114;
            float u = 0.0f;
            float y = intercept;
            ...
            {
                dippr100 = dippr105s[i];
                u = std::clamp(T, dippr100.lo, dippr100.hi);
                y += dippr100.f.c1 * std::pow(u, dippr100.f.c2) / (1.0f + dippr100.f.c3/u + dippr100.f.c4/(u*u));
            }
        ...
        LiquidHeatCapacityTemperatureRelation<si::density<double>> restriction(
        ...
        ) const
        {
            ...
            LiquidHeatCapacityTemperatureRelation<si::density<double>> restricted(*this);
        ...
        LiquidHeatCapacityTemperatureRelation<si::density<double>>& operator+=(const si::density<double> offset)
        {
        ...
        LiquidHeatCapacityTemperatureRelation<si::density<double>>& operator*=(const float scalar)
        {
            for (std::size_t i = 0; i < pexponents.size(); ++i)
            {
                pexponents[i] *= scalar;
        ...
        LiquidHeatCapacityTemperatureRelation<si::density<double>>& operator+=(const LiquidHeatCapacityTemperatureRelation<si::density<double>> other)
        {
    ...
    constexpr LiquidHeatCapacityTemperatureRelation<si::density<double>> get_dippr_temperature_relation_102(
        ...
        return LiquidHeatCapacityTemperatureRelation<si::density<double>>(
            std::vector<ClampedExponent>(0),
            std::vector<ClampedExponent>(0),
            std::vector<ClampedSigmoid>(0),
            std::vector<ClampedDippr105>{ClampedDippr105(Tmin, Tmax, Dippr100(c1, c2, c3, c4))},
    ...
    template<typename si::density<double>>
    LiquidHeatCapacityTemperatureRelation<si::density<double>> operator+(const LiquidHeatCapacityTemperatureRelation<si::density<double>> relation, const LiquidHeatCapacityTemperatureRelation<si::density<double>> other)
    {
        LiquidHeatCapacityTemperatureRelation<si::density<double>> result = relation;
        result += other;
        return result;
    }
    ...
    template<typename si::density<double>>
    LiquidHeatCapacityTemperatureRelation<si::density<double>> operator+(const LiquidHeatCapacityTemperatureRelation<si::density<double>> relation, const si::density<double> offset)
    {
        LiquidHeatCapacityTemperatureRelation<si::density<double>> result = relation;
        result += offset;
        return result;
    ...
    template<typename si::density<double>>
    LiquidHeatCapacityTemperatureRelation<si::density<double>> operator*(const LiquidHeatCapacityTemperatureRelation<si::density<double>> relation, const float scalar)
    {
        LiquidHeatCapacityTemperatureRelation<si::density<double>> result = relation;
        result *= scalar;
        return result;
    ...
    template<typename si::density<double>>
    LiquidHeatCapacityTemperatureRelation<si::density<double>> operator+(const si::density<double> offset, const LiquidHeatCapacityTemperatureRelation<si::density<double>> relation)
    {
        LiquidHeatCapacityTemperatureRelation<si::density<double>> result = relation;
        result += offset;
        return result;
    ...
    template<typename si::density<double>>
    LiquidHeatCapacityTemperatureRelation<si::density<double>> operator-(const LiquidHeatCapacityTemperatureRelation<si::density<double>> relation)
    {
        LiquidHeatCapacityTemperatureRelation<si::density<double>> result = relation;
        result *= 1.0f;
        return result;
    ...
    template<typename si::density<double>>
    LiquidHeatCapacityTemperatureRelation<si::density<double>> operator*(const float scalar, const LiquidHeatCapacityTemperatureRelation<si::density<double>> relation)
    {
        LiquidHeatCapacityTemperatureRelation<si::density<double>> result = relation;
        result *= scalar;
        return result;
    ...
    LiquidHeatCapacityTemperatureRelation does not have a convenient closed form distance metric,
    so equality is determined pragmatically by sampling at given pressures/temperatures
    */
    // template<typename T1>
    // float distance(
    //     const LiquidHeatCapacityTemperatureRelation<T1>& first, 
    //     const LiquidHeatCapacityTemperatureRelation<T1>& second,

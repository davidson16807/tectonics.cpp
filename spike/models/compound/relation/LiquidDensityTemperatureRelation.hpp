...
namespace relation {
    ...
    */
    ...
    public:
        ...
        // zero constructor
        constexpr LiquidDensityTemperatureRelation():
            dippr105s(),
            dippr119s(),
        ...
        constexpr LiquidDensityTemperatureRelation(const si::density<double> intercept):
            dippr105s(0),
            dippr119s(0),
        ...
        constexpr LiquidDensityTemperatureRelation<si::density<double>>& operator=(const LiquidDensityTemperatureRelation<si::density<double>> other)
        {
        ...
        LiquidDensityTemperatureRelation<si::density<double>> restriction(
        ...
        ) const
        {
            ...
            LiquidDensityTemperatureRelation<si::density<double>> restricted(*this);
        ...
        LiquidDensityTemperatureRelation<si::density<double>>& operator+=(const si::density<double> offset)
        {
        ...
        LiquidDensityTemperatureRelation<si::density<double>>& operator*=(const float scalar)
        {
            for (std::size_t i = 0; i < pexponents.size(); ++i)
            {
                pexponents[i] *= scalar;
        ...
        LiquidDensityTemperatureRelation<si::density<double>>& operator+=(const LiquidDensityTemperatureRelation<si::density<double>> other)
        {
    ...
    constexpr LiquidDensityTemperatureRelation<si::density<double>> get_dippr_temperature_relation_102(
        ...
        return LiquidDensityTemperatureRelation<si::density<double>>(
    ...
    template<typename si::density<double>>
    LiquidDensityTemperatureRelation<si::density<double>> operator+(const LiquidDensityTemperatureRelation<si::density<double>> relation, const LiquidDensityTemperatureRelation<si::density<double>> other)
    {
        LiquidDensityTemperatureRelation<si::density<double>> result = relation;
        result += other;
        return result;
    }
    ...
    template<typename si::density<double>>
    LiquidDensityTemperatureRelation<si::density<double>> operator+(const LiquidDensityTemperatureRelation<si::density<double>> relation, const si::density<double> offset)
    {
        LiquidDensityTemperatureRelation<si::density<double>> result = relation;
        result += offset;
        return result;
    ...
    template<typename si::density<double>>
    LiquidDensityTemperatureRelation<si::density<double>> operator*(const LiquidDensityTemperatureRelation<si::density<double>> relation, const float scalar)
    {
        LiquidDensityTemperatureRelation<si::density<double>> result = relation;
        result *= scalar;
        return result;
    ...
    template<typename si::density<double>>
    LiquidDensityTemperatureRelation<si::density<double>> operator+(const si::density<double> offset, const LiquidDensityTemperatureRelation<si::density<double>> relation)
    {
        LiquidDensityTemperatureRelation<si::density<double>> result = relation;
        result += offset;
        return result;
    ...
    template<typename si::density<double>>
    LiquidDensityTemperatureRelation<si::density<double>> operator-(const LiquidDensityTemperatureRelation<si::density<double>> relation)
    {
        LiquidDensityTemperatureRelation<si::density<double>> result = relation;
        result *= 1.0f;
        return result;
    ...
    template<typename si::density<double>>
    LiquidDensityTemperatureRelation<si::density<double>> operator*(const float scalar, const LiquidDensityTemperatureRelation<si::density<double>> relation)
    {
        LiquidDensityTemperatureRelation<si::density<double>> result = relation;
        result *= scalar;
        return result;
    ...
    LiquidDensityTemperatureRelation does not have a convenient closed form distance metric,
    so equality is determined pragmatically by sampling at given pressures/temperatures
    */
    // template<typename T1>
    // float distance(
    //     const LiquidDensityTemperatureRelation<T1>& first, 
    //     const LiquidDensityTemperatureRelation<T1>& second,

...
\begin{tikzcd}
                                   ...
                                   & k_L                                                                & C_L                                        & \omega \arrow[rrr, no head, Rightarrow, bend left]                                                  &                                                    & \sigma \arrow[rrrrrr, no head, Rightarrow, bend left]                  & \omega \arrow[rrr, no head, Rightarrow, bend left]                                & \eta_L                                                                                        &  & \omega                                                                                        & P_{vL}                                                                         & \sigma \arrow[r, shift right] \arrow[d, "BSL2", shift left]           & V_L \arrow[l, "BSL2"']                                                                                  & V_L T_t \arrow[l, dotted] \arrow[u, "Goodman", shift left] &  & V_G                                         &                                                      &                                                 \\

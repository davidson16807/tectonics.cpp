...
TEST_CASE( "CompletedCompound order of magnitude", "[field]" ) {
    SECTION("Properties of compounds should not fall outside orders of magnitude for known values")
    {
        ...
        for (float p = 1.0; p <= 100000000.0; p*=10.0)
        {
            ...
            COMPLETED_COMPOUNDS_VALID(101.0*si::celcius, p*si::pascal) // boiling water
            COMPLETED_COMPOUNDS_VALID(380.0*si::celcius, p*si::pascal) // temperature of Venus
            COMPLETED_COMPOUNDS_VALID(1085.0*si::celcius, p*si::pascal) // melted copper
            COMPLETED_COMPOUNDS_VALID(1510.0*si::celcius, p*si::pascal) // melted stainless steel
            COMPLETED_COMPOUNDS_VALID(2001.0*si::celcius, p*si::pascal) // melted corundum
            COMPLETED_COMPOUNDS_VALID(3501.0*si::kelvin, p*si::pascal) // melted carbon

...
#include "relation/PolynomialRailyardRelation_to_string.hpp"
...
TEST_CASE( "CompletedCompound order of magnitude", "[field]" ) {
    SECTION("Properties of compounds should not fall outside orders of magnitude for known values")
    {
        ...
        std::cout << compound::relation::to_string(compound::library::quartz.solids[0].refractive_index) << std::endl;
    }
}

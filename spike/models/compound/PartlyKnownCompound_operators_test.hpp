...
TEST_CASE( "PartlyKnownCompound infer() increasing", "[compound]" ) {
    SECTION("An attribute of a function's return value either increases or remains the same when compared to the same attribute of the input value")
    {
        ...
        CHECK(compound::PartlyKnownCompound_attribute_known_count(compound::infer(compound::test_water)) >= compound::PartlyKnownCompound_attribute_known_count(compound::test_water));
        CHECK(compound::PartlyKnownCompound_attribute_known_count(compound::infer(compound::published::nitrogen)) >= compound::PartlyKnownCompound_attribute_known_count(compound::published::nitrogen));
        // TODO: uncomment this
        // CHECK(compound::PartlyKnownCompound_attribute_known_count(compound::infer(compound::published::benzene)) >= compound::PartlyKnownCompound_attribute_known_count(compound::published::benzene));
        // CHECK(compound::PartlyKnownCompound_attribute_known_count(compound::infer(compound::published::quartz)) >= compound::PartlyKnownCompound_attribute_known_count(compound::published::quartz));
    }
}
...
namespace tables { 
    ...
    std::map<int, relation::StateFunction<si::specific_heat_capacity<double>>> isobaric_specific_heat_capacity_as_liquid {
        ...
        { ids::hydrogen, // 9.668 * si::joule / (si::gram * si::kelvin), 
        ...
        { ids::ammonia, // 4.700 * si::joule / (si::gram * si::kelvin), // wikipedia
                relation::get_dippr_liquid_heat_capacity_temperature_function_114
        ...
        { ids::ethane, // 68.5 * si::joule / (30.070 * si::gram * si::kelvin), // wikipedia data page
                relation::get_dippr_liquid_heat_capacity_temperature_function_114
        ...
        { ids::hydrogen_cyanide, // missing(),
                relation::get_dippr_quartic_temperature_function_100
                    (si::kelvin, si::joule / (27.02534 * si::kilogram * si::kelvin), 
                    95398.0, -197.52, 0.3883, 0.0, 0.0,
                    259.83, 298.85), 
            },
        { ids::ethanol, // 112.4 * si::joule / (46.068*si::gram*si::kelvin), // wikipedia data page
                relation::get_dippr_quartic_temperature_function_100
        ...
        // { ids::pyrimidine,   },
        // { ids::quartz,       },
        { ids::halite,          relation::state_invariant(15.9 * si::calorie/(80.088 * si::gram*si::kelvin)), // Perry, 1073-1205K
            },
        // { ids::corundum,     },
        // { ids::apatite,      },
        { ids::carbon,          relation::state_invariant(26.0 * si::joule / (12.011 * si::gram * si::kelvin)), // Steinbeck (1990)
        ...
        // { ids::orthoclase,   },
        // { ids::andesine,     },
        { ids::augite,          relation::state_invariant(1.08 * si::kilojoule / (si::kilogram*si::kelvin)), // Schön (2015), for basaltic lava
            },
        // { ids::forsterite,   },
        // { ids::goethite,     },
        // { ids::pyrite,       },
        // { ids::hematite,     },
        { ids::gold,            relation::state_invariant(7.0 * si::calorie/(196.967 * si::gram*si::kelvin)), // Perry, 1336-1573K
            },
        { ids::silver,          relation::state_invariant(8.2 * si::calorie/(107.868 * si::gram*si::kelvin)), // Perry, 1234-1573K
            },
        { ids::copper, 
                relation::get_dippr_quartic_temperature_function_100

...
namespace tables { 
    ...
    std::map<int, relation::StateFunction<si::specific_heat_capacity<double>>> isobaric_specific_heat_capacity_as_liquid {
        ...
        // { ids::pyrimidine,   },
        // { ids::quartz,       },
        { ids::halite, state_invariant(15.9 * si::calorie/(80.088 * si::gram*si::kelvin)), // Perry, 1073-1205K
            },
        // { ids::corundum,     },
        // { ids::apatite,      },
        { ids::carbon, state_invariant(26.0 * si::joule / (12.011 * si::gram * si::kelvin)), // Steinbeck (1990)
        ...
        // { ids::orthoclase,   },
        // { ids::andesine,     },
        { ids::augite, state_invariant(1.08 * si::kilojoule / (si::kilogram*si::kelvin)), // Schön (2015), for basaltic lava
            },
        // { ids::forsterite,   },
        // { ids::goethite,     },
        // { ids::pyrite,       },
        // { ids::hematite,     },
        { ids::gold, state_invariant(7.0 * si::calorie/(196.967 * si::gram*si::kelvin)), // Perry, 1336-1573K
            },
        { ids::silver, state_invariant(8.2 * si::calorie/(107.868 * si::gram*si::kelvin)), // Perry, 1234-1573K
            },
        { ids::copper, 
                get_dippr_quartic_temperature_function_100

...
namespace tables { 
    ...
    std::map<int, relation::GasPropertyStateRelation<si::dynamic_viscosity<double>>> dynamic_viscosity_as_gas {
        ...
        { ids::nitrogen,      // 1.76e-5 * si::pascal * si::second,                               // engineering toolbox, at 20 C
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::carbon_dioxide,      // 1.47e-5 * si::pascal * si::second,                               // engineering toolbox, at 20 C
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::methane,      // 1.10e-5 * si::pascal * si::second,                               // engineering toolbox, at 20 C
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::argon,      // 2.23e-5 * si::pascal * si::second,                               // engineering toolbox, at 20 C
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::helium,      // 1.96e-5 * si::pascal * si::second, // engineering toolbox, at 20 C
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::hydrogen,      // 0.88e-5 * si::pascal * si::second, // engineering toolbox, at 20 C
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::ammonia,      // 0.99e-5 * si::pascal * si::second, // engineering toolbox, at 20 C
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::nitrous_oxide,      // 1.47e-5 * si::pascal * si::second, // engineering toolbox, at 20 C
                relation::get_dippr_temperature_relation_102
                    (si::kelvin, si::pascal * si::second,
                    2.1150e-6, 0.4642, 305.7, 0.0,
                    182.3, 1000.0), // 182.3-1000 K
            },
        { ids::sulfur_dioxide,      // 1.26e-5 * si::pascal * si::second, // engineering toolbox, at 20 C
                relation::get_dippr_temperature_relation_102
                    (si::kelvin, si::pascal * si::second,
                    6.8630e-7, 0.6112, 217.0, 0.0,
                    197.67, 1000.0), // 197.67-1000K
            },
        { ids::nitric_oxide,      // 0.0188 * si::millipascal * si::second, //pubchem
                relation::get_dippr_temperature_relation_102
                    (si::kelvin, si::pascal * si::second,
                    1.4670e-6, 0.5123, 125.4, 0.0,
                    110.0, 1500.0), // 110-1500K
            },
        { ids::carbon_monoxide,      // 1.74e-5 * si::pascal * si::second, // engineering toolbox, at 20 C
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::ethane,      // 9.4 * si::micropascal*si::second,
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::micropascal*si::second, 
        ...
        { ids::benzene,      // 0.75e-5 * si::pascal * si::second, // engineering toolbox, at 20 C
                relation::get_dippr_temperature_relation_102
                    (si::kelvin, si::pascal * si::second,

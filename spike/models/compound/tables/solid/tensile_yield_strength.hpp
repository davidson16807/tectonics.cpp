...
namespace tables { 
    ...
    std::map<int, relation::StateFunction<si::pressure<double>>> tensile_yield_strength_as_solid {
        { ids::water,            relation::state_invariant(1.0 * si::megapascal),                             // brittle, effectively the same as fracture strength
            },
        { ids::nitrogen,            
        ...
        // { ids::benzene,          },
        // { ids::pyrimidine,       },
        { ids::quartz,            relation::state_invariant(48.0 * si::megapascal), // https://material-properties.org/strength-of-materials-tensile-yield/
            },
        { ids::halite,            relation::state_invariant(1.65 * si::megapascal), // https://material-properties.org/strength-of-materials-tensile-yield/
            },
        // { ids::corundum,         },
        // { ids::apatite,          },
        { ids::carbon,            relation::state_invariant(14.0 * si::megapascal), // https://material-properties.org/strength-of-materials-tensile-yield/
            },
        // { ids::calcite,          },
        // { ids::orthoclase,       },
        // { ids::andesine,         },
        ...
        // { ids::pyrite,           },
        // { ids::hematite,         },
        { ids::gold,            relation::state_invariant(300.0 * si::megapascal), // https://material-properties.org/strength-of-materials-tensile-yield/
            },
        // { ids::silver,           },
        { ids::copper,            relation::state_invariant(70.0 * si::megapascal), // engineering toolbox
            },
        // { ids::magnetite,        },
        // { ids::chalcocite,       },
        // { ids::chalcopyrite,     },

...
namespace tables { 
    ...
    std::map<int, relation::StateFunction<si::thermal_conductivity<double>>> thermal_conductivity_as_solid {
        ...
        { ids::oxygen,              relation::state_invariant(0.17 * si::watt / (si::centimeter * si::kelvin)),  // Jezowski (1993)
            },
        { ids::carbon_dioxide,              
                relation::get_interpolated_temperature_function
                    ( si::kelvin, si::milliwatt/(si::centimeter * si::kelvin),
        ...
        { ids::hydrogen,              relation::state_invariant(1.819 * si::watt / ( si::meter * si::kelvin )), // wikipedia
            },
        // { ids::ammonia,          },
        { ids::ozone,              relation::state_invariant(5.21e-4 * si::calorie / (si::second*si::centimeter2*si::kelvin/si::centimeter)), // Streng (1961)
            },
        { ids::nitrous_oxide,              
                relation::get_interpolated_temperature_function
                    ( si::kelvin, si::milliwatt/(si::centimeter * si::kelvin),
        ...
        { ids::halite,              relation::state_invariant(5.55 * si::watt / ( si::meter * si::kelvin )), // Wilkens (2011)
            },
        ...
        { ids::apatite,              relation::state_invariant(1.38 * si::watt / (si::meter*si::kelvin)), // Schön (2015)
            },
        ...
        { ids::calcite,              relation::state_invariant(3.59 * si::watt / (si::meter * si::kelvin)), // Schön (2015)
            },
        { ids::orthoclase,              relation::state_invariant(2.31 * si::watt/(si::meter*si::kelvin)), // Schön (2015)
            },
        { ids::andesine,              relation::state_invariant(1.69 * si::watt / (si::centimeter * si::kelvin)), // Schön (2015), for anorthite
            },
        { ids::augite,              relation::state_invariant(4.66 * si::watt / (si::centimeter * si::kelvin)), // Schön (2015)
            },
        { ids::forsterite,              relation::state_invariant(7.69 * si::watt / (si::centimeter * si::kelvin)), // Schön (2015)
            },
        { ids::goethite,              relation::state_invariant(2.91 * si::watt / (si::meter * si::kelvin)), // Cermak (1988)
            },
        { ids::pyrite,              relation::state_invariant(19.21 * si::watt / (si::meter * si::kelvin)), // Schön (2015)
            },
        { ids::hematite,              relation::state_invariant(11.28 * si::watt / (si::meter * si::kelvin)), // Schön (2015)
            },
        ...
        { ids::magnetite,              relation::state_invariant(5.1 * si::watt / (si::centimeter * si::kelvin)), // Schön (2015)
            },
        // { ids::chalcocite,       },
        { ids::chalcopyrite,              relation::state_invariant(8.19 * si::watt / (si::centimeter * si::kelvin)), // Cermak (1988), for chalcopyrite
            },
    };

...
namespace table { 
    ...
    std::std::map<int, relation::StateFunction<si::density<double>>> density_as_liquid {
        ...
        { ids::nitrogen,                // state_invariant(0.4314*si::gram/si::centimeter3), // Johnson (1960), @ si::atmosphere, 125.01*si::kelvin
        ...
        { ids::pyrimidine,                state_invariant(1.016 * si::gram/si::centimeter3), // wikipedia
            },
        { ids::quartz,                         state_invariant(2180.0 * si::kilogram/si::meter3), // from Murase and McBirney (1973), for rhyolitic magma
            },
        { ids::halite,                1549.0 * si::kilogram/si::meter3,  // wikipedia data page
            },
        // { ids::corundum,     },
        // { ids::apatite,      },
        { ids::carbon,                state_invariant(1.6*si::gram/si::centimeter3), // Bundy, referenced in Steinbeck (1990)
            },
        // { ids::calcite,      },
        { ids::orthoclase,                         state_invariant(2180.0 * si::kilogram/si::meter3), // from Murase and McBirney (1973), for rhyolitic magma
            },
        { ids::andesine,                         state_invariant(2180.0 * si::kilogram/si::meter3), // from Murase and McBirney (1973), for rhyolitic magma
            },
        { ids::augite,                         state_invariant(2800.0 * si::kilogram/si::meter3), // from Murase and McBirney (1973), for basaltic  magma
            },
        // { ids::forsterite,   },
        // { ids::goethite,     },
        // { ids::pyrite,       },

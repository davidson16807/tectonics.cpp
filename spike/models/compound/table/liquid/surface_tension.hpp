...
namespace table { 
    ...
    std::std::map<int, relation::StateFunction<si::surface_energy<double>>> surface_tension_as_liquid {
        ...
        { ids::ozone,        state_invariant(38.1 * si::dyne/si::centimeter), // -182.7C, Jasper (1972)
            },
        { ids::nitrous_oxide,        
                get_refprop_liquid_surface_tension_temperature_function
                    (si::kelvin, si::newton/si::meter,
        ...
        { ids::formaldehyde,        state_invariant(27.3797 * si::dyne/si::centimeter), // 25 °C, PubChem
            },
        { ids::formic_acid,        
                get_interpolated_temperature_function
        ...
        { ids::quartz,                 state_invariant(312.0 * si::dyne / si::centimeter), // 1400C, Shartsis (1951)
            },
        { ids::halite,        
                get_interpolated_temperature_function
                    (si::celcius, si::dyne/si::centimeter,

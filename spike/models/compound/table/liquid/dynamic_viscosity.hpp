...
namespace table { 
    ...
    std::map<int, relation::StateFunction<si::dynamic_viscosity<double>> dynamic_viscosity_as_liquid {
        ...
        // { ids::pyrimidine,   },
        { ids::quartz,               state_invariant(exp(10.0) * si::poise), // Doremus (2002), at 1400 C
            },
        { ids::halite,      
        ...
        { ids::corundum,      
                field::StateFunction<si::dynamic_viscosity<double>>([](const si::pressure<double> p, const si::temperature<double> T){ 
        ...
        // { ids::carbon,       },
        // { ids::calcite,      },
        { ids::orthoclase,               state_invariant(1e8 * si::poise), // observed by Bowen (1934) for molten Orthoclase, seems large compared to other silicates, but continental crust has been observed to have higher viscosity than oceanic (Itô 1979, "Rheology of the crust...", I can only get a hold of the abstract)
            },
        { ids::andesine,               state_invariant(1.38e2 * si::poise), // 1.36-1.19 poises, observed by Kani for andesitic basaltic magma at 1400C, referenced by Bowen (1934)
        ...
        // { ids::augite,       },
        { ids::forsterite,               state_invariant(1.27e2 * si::poise), // 1.36-1.19 poises, observed by Kani for olivine basaltic magma at 1400C, referenced by Bowen (1934)

...
namespace table { 
    ...
    std::std::map<int, relation::GasPropertyStateRelation<si::specific_heat_capacity<double>>> isobaric_specific_heat_capacity_as_gas {
        { ids::water, 
        ...
        { ids::nitrogen, // 1.341 * si::joule / (si::gram * si::kelvin),
        ...
        { ids::carbon_dioxide, // 36.61 * si::joule / (44.01 * si::gram * si::kelvin),             // wikipedia
                relation::get_sigmoid_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::joule/(si::gram * si::kelvin),
        ...
        { ids::methane, // 2.218 * si::joule / (si::gram * si::kelvin),                     
                relation::get_sigmoid_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::joule/(si::gram * si::kelvin),
        ...
        { ids::ammonia, // 35.06 * si::joule / (17.031 * si::gram * si::kelvin), // wikipedia data page
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::joule/(si::gram * si::kelvin),
        ...
        { ids::carbon_monoxide, // 29.0 * si::joule / (28.010 * si::gram * si::kelvin), // wikipedia data page
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::joule/(si::gram * si::kelvin),
        ...
        { ids::ethane, // 52.49 * si::joule / (30.070 * si::gram * si::kelvin), // wikipedia data page
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::joule/(si::gram * si::kelvin),
        ...
        { ids::ethanol, 78.28 * si::joule / (46.068*si::gram*si::kelvin), // wikipedia data page
            }
        // { ids::formaldehyde,     },
        { ids::formic_acid, 45.68 * si::joule / (46.026*si::gram*si::kelvin), // wikipedia data page
            }
        ...
        { ids::benzene, // 82.44 * si::joule / (79.109 * si::gram * si::kelvin),
                relation::get_exponent_pressure_temperature_relation
                    (si::kelvin, si::megapascal, si::joule/(si::gram * si::kelvin),

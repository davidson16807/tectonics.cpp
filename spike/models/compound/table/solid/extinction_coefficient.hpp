...
namespace table { 
    ...
    std::std::map<int, relation::StateFunction<si::wavenumber<double>,double,0,1>> extinction_coefficient_as_solid {
        { ids::water, 
        ...
        // { ids::carbon_monoxide,  },
        // { ids::ethane,           },
        { ids::hydrogen_cyanide,            1.876e-4, // Moore 2010, 95K 5000 cm-1
            },
        // { ids::ethanol,          },
        // { ids::formaldehyde,     },
        // { ids::formic_acid,      },

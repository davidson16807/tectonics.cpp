...
namespace table { 
    ...
    std::std::map<int, relation::StateFunction<si::pressure<double>>> tensile_modulus_as_solid {
        { ids::water,                   state_invariant(9.332 * si::gigapascal),                           // gammon (1983)
            },
        { ids::nitrogen,                   
        ...
        { ids::methane,                   state_invariant(30.83 * si::gigapascal), // Manzhelii (2003), @ si::standard_pressure, 30.0*si::kelvin
            },
        { ids::argon,                   
                get_interpolated_temperature_function
                    (si::kelvin, si::kilobar,
        ...
        // { ids::benzene,          },
        // { ids::pyrimidine,       },
        { ids::quartz,                   state_invariant(0.8680e11*si::pascal), 
            },
        // { ids::halite,           // state_invariant(0.4947e11*si::pascal), // values from Perry produce negative bulk modulus so they are commented out
            // }
        // { ids::corundum,         },
        { ids::apatite,                   state_invariant(1.667e11*si::pascal),
            },
        // { ids::carbon,           },
        // { ids::calcite,          },
        // { ids::orthoclase,       },
        // { ids::andesine,         },
        // { ids::augite,           },
        { ids::forsterite,                   state_invariant(3.2848e11*si::pascal),
            },
        // { ids::goethite,         },
        { ids::pyrite,                   state_invariant(3.818e11*si::pascal),
            },
        { ids::hematite,                   state_invariant(2.4243e11*si::pascal), 
            },
        { ids::gold,                   state_invariant((76.0+81.0)/2.0*si::gigapascal), // https://www.azom.com/properties.aspx?ArticleID=598 // state_invariant(1.9244e11*si::pascal), // values from Perry produce negative bulk modulus so they are commented out
            },
        { ids::silver,                   state_invariant(1.2399e11*si::pascal),
            },
        { ids::copper,                   state_invariant(1.683e11*si::pascal),
            },
        { ids::magnetite,                   state_invariant(2.730e11*si::pascal),
            },
        // { ids::chalcocite,       },
        // { ids::chalcopyrite,     },
    };

...
compound::phase::PartlyKnownGas steam {
    ...
    /*density*/                           std::monostate(),
    /*refractive_index*/                  compound::relation::spline_constant<si::wavenumber, float, 0,1>(1.000261f) // engineering toolbox
};
compound::phase::PartlyKnownGas nitrogen_gas {
    ...
    /*density*/                           std::monostate(),
    /*refractive_index*/                  compound::relation::spline_constant<si::wavenumber, float, 0,1>(1.0002990f)
};
compound::phase::PartlyKnownGas dummy_gas  {
    ...
    /*refractive_index*/                  compound::relation::spline_constant<si::wavenumber, float, 0,1>(1.3f)
};
compound::phase::PartlyKnownGas perflouromethane_gas {
    ...
    /*dynamic_viscosity*/                 std::monostate(),
    /*density*/                           std::monostate(),
    /*refractive_index*/                  compound::relation::spline_constant<si::wavenumber, float, 0,1>(1.0004823f)
};

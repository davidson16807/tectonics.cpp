...
TEST_CASE( "CompletedLiquid to_string() appreciable difference preservation", "[field]" ) {
	compound::phase::CompletedLiquid nudge_isobaric_specific_heat_capacity   = known_dummy_liquid; nudge_isobaric_specific_heat_capacity   .isobaric_specific_heat_capacity   = 1.01 * nudge_isobaric_specific_heat_capacity   .isobaric_specific_heat_capacity   (compound::field::StateParameters());
	...
	{
		CHECK(compound::phase::to_string(nudge_isobaric_specific_heat_capacity)   != compound::phase::to_string(known_dummy_liquid));

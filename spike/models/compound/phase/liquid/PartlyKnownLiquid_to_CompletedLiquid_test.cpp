...
TEST_CASE( "PartlyKnownLiquid complete() associativity", "[phase]" ) {
    ...
    {
        CHECK(compound::phase::complete(unknown_liquid, compound::phase::complete(liquid_nitrogen,known_liquid_nitrogen)) == 
              compound::phase::complete(compound::phase::complete(unknown_liquid,liquid_nitrogen),known_liquid_nitrogen));

        CHECK(compound::phase::complete(unknown_liquid, compound::phase::complete(liquid_nitrogen,known_dummy_liquid)) == 
              compound::phase::complete(compound::phase::complete(unknown_liquid,liquid_nitrogen),known_dummy_liquid));
        ...
        CHECK(compound::phase::complete(molten_silica, compound::phase::complete(liquid_nitrogen,known_liquid_nitrogen)) == 
              compound::phase::complete(compound::phase::complete(molten_silica,liquid_nitrogen),known_liquid_nitrogen));

        CHECK(compound::phase::complete(molten_silica, compound::phase::complete(liquid_nitrogen,known_dummy_liquid)) == 
              compound::phase::complete(compound::phase::complete(molten_silica,liquid_nitrogen),known_dummy_liquid));

        CHECK(compound::phase::complete(liquid_nitrogen, compound::phase::complete(molten_silica,known_liquid_nitrogen)) == 
              compound::phase::complete(compound::phase::complete(liquid_nitrogen,molten_silica),known_liquid_nitrogen));

        CHECK(compound::phase::complete(liquid_nitrogen, compound::phase::complete(molten_silica,known_dummy_liquid)) == 
              compound::phase::complete(compound::phase::complete(liquid_nitrogen,molten_silica),known_dummy_liquid));

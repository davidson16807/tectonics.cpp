...
TEST_CASE( "CompletedSolid to_string() appreciable difference preservation", "[field]" ) {
	compound::phase::CompletedSolid nudge_specific_heat_capacity           = known_dummy_solid; nudge_specific_heat_capacity           .specific_heat_capacity           = 1.01 * nudge_specific_heat_capacity           .specific_heat_capacity        (compound::field::StateParameters());
	...
	compound::phase::CompletedSolid nudge_absorption_coefficient           = known_dummy_solid; nudge_absorption_coefficient           .absorption_coefficient           = 1.01 * nudge_absorption_coefficient           .absorption_coefficient        (compound::field::SpectralParameters());
	...
	{
		CHECK(compound::phase::to_string(nudge_specific_heat_capacity          ) != compound::phase::to_string(known_dummy_solid));

...
namespace phase {
	std::string to_string(const PartlyKnownSolid& solid, const field::StateParameters& state, const field::SpectralParameters& spectrum)
	{
		...
		out += "Refractive Index                     " + relation::to_string(solid.refractive_index                    )     + "\n";
		out += "Extinction Coefficient               " + relation::to_string(solid.extinction_coefficient              )     + "\n";
		out += "Absorption Coefficient               " + relation::to_string(solid.absorption_coefficient              )     + "\n";

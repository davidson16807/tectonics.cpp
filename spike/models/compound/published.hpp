...
PartlyKnownCompound water (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  9.73e1, 6.05e2, 7.37e3, 1.65e4, 2.98e4, 6.50e4, 9.73e4, 1.38e5, 1.62e5, 2.63e5, 3.35e5, 4.39e5, 5.15e5, 5.89e5, 6.93e5, 9.82e5, 1.25e6, 1.64e6, 2.08e6, 2.38e6, 2.41e6, 2.44e6, 2.47e6, 2.53e6, 2.59e6, 2.63e6, 2.73e6, 2.78e6, 2.93e6, 2.98e6, 3.05e6, 3.08e6, 5.11e6, 5.63e6, 6.04e6, 6.45e6, 6.86e6, 8.04e6, 9.68e6, 1.08e7, 1.24e7, 1.37e7, 2.37e7, 3.94e7, 6.98e7, 1.69e8 },
          std::vector<float>{  -24.98, -24.44, -23.93, -23.46, -23.46, -22.97, -23.70, -23.77, -23.11, -24.44, -22.46, -25.14, -24.47, -25.68, -25.10, -27.10, -28.15, -29.10, -30.25, -29.38, -29.28, -29.28, -29.47, -29.22, -29.47, -29.55, -29.28, -29.21, -29.27, -28.95, -28.71, -28.69, -25.41, -21.62, -21.41, -21.51, -21.76, -21.09, -20.98, -20.74, -20.82, -20.75, -20.83, -21.08, -21.54, -22.44 }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.000261f)                                        
    },
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       //1.33336,
            relation::get_spectral_linear_interpolation_function_of_wavelength
                (si::micrometer, 1.0f,
                 std::vector<float>{0.2,   0.3,   0.425,  0.55, 0.675,   0.8, 0.925,   1.4,   2.4,   2.8,  3.05,  3.3,   5.6,   6.6,   7.6,  13.0,  15.5,  18.0,  21.0,  26.0,  32.0,  42.0,  60.0, 110.0, 160.0,200.0},
                 std::vector<float>{1.396, 1.349, 1.338, 1.333, 1.331, 1.329, 1.328, 1.321, 1.279, 1.142, 1.426, 1.45, 1.289, 1.334, 1.302, 1.146, 1.297, 1.423, 1.487, 1.539, 1.546, 1.522, 1.703, 1.966, 2.081, 2.13}),
                // Hale (1973)
        /*extinction_coefficient*/ 
            relation::get_spectral_linear_interpolation_function_of_wavelength
                (si::micrometer, 1.0f,
                 std::vector<float>{0.2,     0.3,     0.425,   0.55,     0.675,    0.8,      0.925,    1.4,      2.8,   3.0,   3.3,    3.6,     4.1,     4.6,    5.6,    6.1,      6.6,    9.2,   10.5,  13.0,  15.5,  18.0,  32.0,  60.0, 200.0},
                 std::vector<float>{1.1e-07, 1.6e-08, 1.3e-09, 1.96e-09, 2.23e-08, 1.25e-07, 1.06e-06, 0.000138, 0.115, 0.272, 0.0368, 0.00515, 0.00562, 0.0147, 0.0142, 0.131, 0.0356, 0.0415, 0.0662, 0.305, 0.414, 0.426, 0.324, 0.587, 0.504})
                // Hale (1973)
    },
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid { // ice1h, regular ice
            ...
            /*refractive_index*/       
                relation::get_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0f,
                     std::vector<float>{0.0443, 0.0528, 0.067,  0.0886, 0.1181, 0.137,  0.1468, 0.158,  0.177,  0.197,  0.41,   0.51,   0.81,   1.515,  1.76,   1.923,  2.29,   2.52,   2.817,  2.985,  3.175,  3.39,   3.775,  4.56,   5.714,  6.329,  7.143,  8.333,  10.31,  11.9,   14.08,  17.24,  22.22,  34.48,  46.15,  55,     62.5,   76.29,  210, 1300.0},
                     std::vector<float>{0.8228, 0.8505, 0.9679, 1.3807, 1.3783, 1.2849, 1.5729, 1.6309, 1.4462, 1.3974, 1.3185, 1.3126, 1.3047, 1.2914, 1.2843, 1.2771, 1.2545, 1.2232, 1.0657, 1.018, 1.6336, 1.5086, 1.385, 1.3482, 1.2933, 1.3178, 1.3236, 1.2964, 1.1501, 1.2546, 1.5701, 1.5303, 1.4575, 1.253, 1.2543, 1.7955, 1.6372, 1.8504, 1.8114, 1.7868}),
                    // Warren (2008)
            /*extinction_coefficient*/ 
                relation::get_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0f,
                     std::vector<float>{0.0443,   0.0528,   0.067,    0.0886,   0.1181,   0.137,    0.1468,   0.158,    0.177,    0.197,    0.41,     0.51,     0.61,     0.71,     0.81,     0.91,     1.01,     1.11,     1.21,     1.31,     1.41,     1.515,    1.76,     1.923,    2.13,     2.29,     2.52,     2.817,    3.003,    3.175,    3.39,     3.775,    4.56,     5.714,    6.329,    7.143,    8.333,    10.31,    11.9,     14.08,    17.24,    22.22,    34.48,    46.15,    55,       76.29,    210,      140000,   240000,   2000000  },
                     std::vector<float>{0.164,    0.268,    0.492,    0.468,    0.244,    0.271,    0.345,    0.083,    1.061e-05,2.816e-10,2.669e-11,8.036e-10,6.89e-09, 3.44e-08, 1.4e-07,  4.44e-07, 2e-06,    1.76e-06, 8.66e-06, 1.31e-05, 3.442e-05,0.0005143,0.0001522,0.000706, 0.0005255,0.0002538,0.0007685,0.03245,  0.438,    0.372,    0.04286,  0.006966, 0.03007,  0.03256,  0.0617,   0.0494,   0.037,    0.075,    0.409,    0.271,    0.107,    0.029,    0.1615,   0.7684,   0.4214,   0.334,    0.04282,  9.36e-05, 0.0001066,0.0006596}),
                    // Warren (2008)
...
PartlyKnownCompound nitrogen (
    ...
    /*molecular_absorption_cross_section*/ 
        relation::get_spectral_linear_interpolation_function_of_wavelength_for_log10_sample_output
            (si::meter, si::meter2,
             std::vector<float>{ 8.22e6, 9.25e6, 9.94e6, 1.03e7, 1.13e7, 1.21e7, 1.89e7, 3.35e7, 3.93e7, 9.31e7, 1.07e9 },
             std::vector<float>{ -26.22, -23.04, -20.64, -20.27, -20.29, -20.62, -20.58, -20.93, -20.96, -21.80, -23.38 }),
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/                      relation::spectral_constant(1.19876f),
        /*extinction_coefficient*/                missing()
    },
            ...
            /*vapor_pressure*/                    
                get_interpolated_temperature_function
                    (si::celcius, si::millimeter_mercury,
                     ...
                     std::vector<double>{1.0,    10.0,   100.0,  760.0  }), // Perry
            /*refractive_index*/                  relation::spectral_constant(1.25f), // wikipedia
            /*extinction_coefficient*/            missing(),
            /*absorption_coefficient*/            missing(),
...
PartlyKnownCompound oxygen (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  5.58e6, 5.72e6, 6.36e6, 6.93e6, 7.26e6, 7.40e6, 7.50e6, 7.65e6, 7.74e6, 7.86e6, 8.05e6, 8.24e6, 8.36e6, 8.43e6, 8.52e6, 8.66e6, 8.80e6, 8.88e6, 8.99e6, 9.06e6, 9.20e6, 9.28e6, 9.75e6, 1.05e7, 1.13e7, 1.22e7, 1.36e7, 1.46e7, 1.83e7, 2.14e7, 3.50e7, 6.28e7, 1.11e8, 4.23e8  },
          std::vector<float>{  -24.99, -22.55, -21.15, -20.81, -20.86, -21.15, -21.70, -22.61, -22.16, -23.10, -21.82, -24.11, -22.09, -24.11, -21.91, -23.78, -21.50, -23.63, -23.80, -22.07, -22.14, -22.21, -21.36, -21.04, -21.01, -20.68, -20.60, -20.65, -20.59, -20.70, -20.81, -21.28, -21.79, -23.05  }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.0002709f),
            // field::SpectralFunction<double>([](
            //     const si::wavenumber nlo, 
            //     const si::wavenumber nhi, 
            //     const si::pressure p, 
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.2243f),
        /*extinction_coefficient*/ missing()
    },
...
PartlyKnownCompound carbon_dioxide (
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.0004493f),
        // field::SpectralFunction<double>([](
        //     const si::wavenumber nlo, 
        //     const si::wavenumber nhi, 
        //     const si::pressure p, 
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.6630f),
        /*extinction_coefficient*/ missing()
...
PartlyKnownCompound methane (
    ...
    phase::PartlyKnownGas {
        ...
        /*refractive_index*/       // 1.000444,
            relation::get_spectral_linear_interpolation_function_of_wavelength_for_log10_sample_input
                (si::micrometer, 1.0f,
                 std::vector<float>{    1.67,     2.70,     3.01,     3.66,     3.79,     4.46,     5.66,     6.51,     7.00,     8.38,     8.95,    10.09,    10.86,    11.54,    11.93,    12.37,    13.22,    13.63,    14.02,    14.83},
                 std::vector<float>{1.000430, 1.000425, 1.000417, 1.000440, 1.000437, 1.000431, 1.000427, 1.000419, 1.000402, 1.000466, 1.000451, 1.000445, 1.000442, 1.000443, 1.000440, 1.000441, 1.000440, 1.000439, 1.000444, 1.000439}),
    },
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.2730f), 
        /*extinction_coefficient*/ missing()
    },
...
PartlyKnownCompound argon (
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.000281f),
        // field::SpectralFunction<double>([](
        //     const si::wavenumber nlo, 
        //     const si::wavenumber nhi, 
        //     const si::pressure p, 
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.23f),
        /*extinction_coefficient*/ missing()
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid {
            ...
            /*refractive_index*/                  relation::spectral_constant(1.2703f),
            /*extinction_coefficient*/            missing(),
            /*absorption_coefficient*/            missing(),
...
PartlyKnownCompound helium (
    ...
    /*molecular_absorption_cross_section*/ relation::spectral_constant(1e-35 * si::meter2),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.000036),
            // field::SpectralFunction<double>([](
            //     const si::wavenumber nlo, 
            //     const si::wavenumber nhi, 
            //     const si::pressure p, 
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.02451),
            // relation::get_dewaele2003_pressure_function
...
PartlyKnownCompound hydrogen (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{   5e6, 8.06e6, 8.48e6, 9.97e6, 1.05e7, 1.13e7, 1.41e7, 2.66e7, 5.74e7  },
          std::vector<float>{ -29.5, -23.05, -22.54, -20.41, -20.44, -20.79, -20.97, -21.66, -22.68  }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.0001392f),
            // field::SpectralFunction<double>([](
            //     const si::wavenumber nlo, 
            //     const si::wavenumber nhi, 
            //     const si::pressure p, 
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.1096),
...
PartlyKnownCompound ammonia (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  4.35e6, 4.84e6, 5.26e6, 6.14e6, 6.61e6, 7.28e6, 8.03e6, 9.32e6, 1.06e7, 1.23e7, 2.52e7, 5.80e7, 1.93e8f  },
          std::vector<float>{  -26.43, -21.51, -21.17, -21.60, -21.58, -21.00, -20.92, -20.56, -20.76, -20.44, -20.78, -21.60, -22.61f  }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.000376),
        // field::SpectralFunction<double>([](
        //     const si::wavenumber nlo, 
        //     const si::wavenumber nhi, 
        //     const si::pressure p, 
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/        1.3944,
            // get_interpolated_temperature_function
            //     (si::celcius, 1.0,
            //      std::vector<float>{ -20.0,  40.0}, 
            //      std::vector<float>{1.3475, 1.321}), // Francis (1960)
        /*extinction_coefficient*/ missing()
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid {
            ...
            /*extinction_coefficient*/            
                relation::get_spectral_linear_interpolation_function_of_wavenumber
                    (1.0/si::centimeter, 1.0f,
                     std::vector<float>{ 4017.54, 3412.28, 3381.57, 3364.03, 3342.10, 3197.36, 3144.73, 1697.36, 1627.19, 1583.33, 1188.59, 1140.35, 1078.94, 1021.93,  969.29,  631.57,  561.40,  473.68,  403.50,  144.73,   83.333 },
                     std::vector<float>{   1.100,   1.103,   1.285,   1.282,   1.160,   1.141,   1.097,   1.103,   1.166,   1.129,   1.113,   1.216,   1.530,   1.132,   1.110,   1.125,   1.169,   1.342,   1.395,   1.226,   1.219 }),
            /*absorption_coefficient*/            missing(),
...
PartlyKnownCompound ozone (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{   0.0,  2e5,  7e5,  9e5,1.6e6,  2e6,2.5e6,2.8e6,  3e6,3.5e6,4.6e6,  6e6,7.7e6,1.2e7f },
          std::vector<float>{ -28.0,-26.0,-31.0,-28.0,-24.0,-25.0,-27.0,-24.5,-23.0,-21.0,-22.5,-22.0,-21.0,-21.0  }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.00052f)
    },
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.2226f),
        /*extinction_coefficient*/ missing()
...
PartlyKnownCompound nitrous_oxide (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  3.16e6, 3.29e6, 3.85e6, 4.15e6, 5.10e6, 5.62e6, 5.95e6, 6.29e6, 6.33e6, 6.66e6, 6.91e6, 7.25e6, 7.31e6, 7.73e6, 8.00e6, 9.68e6, 1.07e7, 1.32e7, 1.54e7, 2.82e7, 4.30e7, 7.11e7, 2.34e8  },
          std::vector<float>{  -28.02, -27.33, -27.38, -26.88, -23.17, -22.83, -23.13, -23.43, -23.43, -21.58, -21.14, -20.67, -22.14, -20.17, -20.53, -20.62, -20.75, -20.37, -20.40, -20.57, -20.85, -21.29, -22.43  }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.000516f)
    },
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.238f),
        /*extinction_coefficient*/ missing()
            ...
            /*vapor_pressure*/                    
                get_interpolated_temperature_function
                    (si::celcius, si::millimeter_mercury,
                     ...
                     std::vector<double>{1.0,    10.0,   100.0,  760.0  }), // Perry
            /*refractive_index*/                  relation::spectral_constant(1.317f), // Hudson (2020)
            /*extinction_coefficient*/            missing(),
            /*absorption_coefficient*/            missing(),
...
PartlyKnownCompound  sulfur_dioxide (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{2.47e6,2.69e6,2.91e6,3.12e6,3.41e6,3.76e6,4.25e6,4.37e6,4.95e6,5.45e6,6.01e6,6.63e6,7.36e6,7.95e6,8.51e6,8.80e6,9.07e6,9.35e6},
          std::vector<float>{-28.29,-25.86,-25.90,-23.18,-22.04,-22.33,-23.69,-22.55,-20.88,-21.43,-22.48,-21.25,-21.45,-19.92,-21.12,-20.35,-20.88,-20.68}),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.000686f)
    },
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/        relation::spectral_constant(1.3396f),
            // get_interpolated_temperature_function
            //     (si::celcius, 1.0,
            //      std::vector<float>{-20.0, 40.0}, 
            //      std::vector<float>{ 1.37, 1.33}), // Francis (1960)
        /*extinction_coefficient*/ missing()
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid {
            ...
            /*extinction_coefficient*/            
                relation::get_spectral_linear_interpolation_function_of_wavenumber
                    (1.0/si::centimeter, 1.0f,
                     std::vector<float>{ 4032.02, 1483.46, 1381.00, 1361.79, 1336.18, 1323.37, 1321.24, 1299.89, 1171.82, 1163.29, 1150.48, 1135.54,  569.90,  552.83,  537.89,  525.08,  522.95,  508.00,  405.55,  405.55 },
                     std::vector<float>{   2.598,   2.598,   2.617,   2.653,   3.233,   3.190,   2.724,   2.604,   2.604,   3.043,   3.052,   2.607,   2.601,   2.623,   3.040,   3.052,   2.613,   2.595,   2.601,   2.601 }),
            /*absorption_coefficient*/            
                relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
                    (1.0/si::centimeter, 1.0/si::centimeter,
                     std::vector<float>{  5097.2,  5028.0,  5008.2,  4968.7,  4948.9,  4731.5,  4691.9,  4672.2,  4553.5,  4533.8,  4514.0,  4108.7,  4089.0,  4059.3,  4019.8,  3990.1,  3920.9,  3911.0,  3881.4,  3871.5,  3841.8,  3812.2,  3752.9,  3743.0,  3713.3,  3644.2,  3614.5,  3575.0,  3525.5,  3495.9,  3456.3,  3416.8,  3397.0,  3357.5,  3327.8,  3308.1,  3041.2,  2981.9,  2942.3,  2843.5,  2823.7,  2774.3,  2734.8,  2665.6,  2616.1,  2566.7,  2537.1,  2477.8,  2448.1,  2359.1,  2309.7,  2280.1,  2240.5 },
                     std::vector<float>{  -2.262,  -0.619,  -2.227,  -1.878,  -2.227,  -2.210,  -0.759,  -2.210,  -2.227,  -1.843,  -2.227,  -2.245,  -1.493,  -2.157,  -1.895,  -1.196,   0.343,  -1.161,  -0.462,  -2.000,  -2.192,  -2.192,  -0.794,  -2.210,  -1.790,  -1.493,  -0.584,   1.199,  -0.741,  -1.528,  -1.790,   0.150,  -2.087,  -2.157,  -1.476,  -2.192,  -2.227,  -0.479,  -2.227,  -2.227,   0.010,  -0.899,  -0.706,   0.675,  -0.339,   0.517,   0.430,   2.685,   1.304,   0.045,   2.108,   0.395,   0.255 }),
...
// representative of industrial emissions
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{4.82e6, 5.61e6, 5.83e6, 6.55e6, 7.23e6, 7.65e6, 8.31e6, 9.94e6, 1.11e7, 1.26e7, 1.67e7, 4.05e7, 7.18e7, 1.85e8},
          std::vector<float>{-22.20, -21.43, -21.37, -21.56, -21.49, -21.56, -21.57, -20.71, -20.41, -20.71, -20.60, -20.94, -21.42, -22.55}),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.000297f)
    },
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.330f),
        /*extinction_coefficient*/ missing()
...
PartlyKnownCompound carbon_monoxide (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  4.83e6, 4.85e6, 4.88e6, 5.00e6, 5.02e6, 5.05e6, 5.17e6, 5.19e6, 5.22e6, 5.33e6, 5.36e6, 5.38e6, 5.49e6, 5.51e6, 5.55e6, 5.64e6, 5.67e6, 5.68e6, 5.71e6, 6.02e6, 6.85e6, 7.98e6, 8.42e6, 9.28e6, 1.00e7, 1.05e7, 1.13e7, 1.21e7, 1.38e7, 2.10e7, 4.54e7, 5.15e8 },
          std::vector<float>{  -28.38, -24.93, -28.40, -28.39, -24.91, -28.40, -28.39, -25.16, -28.42, -28.39, -25.52, -28.39, -28.38, -25.72, -28.41, -28.40, -25.96, -23.41, -28.42, -22.47, -20.89, -21.48, -22.01, -20.72, -20.93, -20.48, -20.35, -20.56, -20.56, -20.68, -21.04, -22.55 }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.00036320), //https://refractiveindex.info
            // field::SpectralFunction<double>([](
            //     const si::wavenumber nlo, 
            //     const si::wavenumber nhi, 
            //     const si::pressure p, 
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid { // beta: warmer form, transitions to alpha at 61.5K
            ...
            /*absorption_coefficient*/            
                relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
                    (1.0/si::centimeter, 1.0/si::centimeter,
                     std::vector<float>{  6439.7,  6390.1,  6350.4,  6320.7,  6300.8,  6211.6,  6191.7,  6152.1,  4486.0,  4466.1,  4366.9,  4327.3,  4287.6,  4257.9,  4238.0,  4208.3,  4178.5,  4158.7,  4138.8,  4079.3,  4059.5,  4029.8 },
                     std::vector<float>{  -2.678,  -1.542,  -2.661,   0.407,  -2.678,  -2.695,  -1.576,  -2.695,  -2.661,  -1.814,  -0.424,   0.373,   0.017,   2.780,  -0.983,  -0.576,  -1.576,   0.797,  -2.678,  -2.695,  -1.797,  -2.678 }),
...
PartlyKnownCompound ethane (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{ 5.6e6, 6.25e6, 6.73e6, 7.49e6, 8.23e6, 9.26e6, 1.01e7, 1.14e7, 2.42e7, 5.43e7, 1.72e8 },
          std::vector<float>{ -35.0, -25.67, -21.86, -20.50, -20.60, -20.27, -20.25, -20.08, -20.57, -21.44, -22.57 }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.0377),
        // field::SpectralFunction<double>([](
        //     const si::wavenumber nlo, 
        //     const si::wavenumber nhi, 
        //     const si::pressure p, 
...
PartlyKnownCompound hydrogen_cyanide (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  8.50e6, 8.58e6, 9.19e6, 9.59e6, 9.89e6, 9.99e6, 1.01e7, 1.02e7, 1.03e7, 1.05e7, 1.07e7, 1.09e7, 1.26e7, 1.35e7, 1.41e7, 1.46e7, 1.62e7 },
          std::vector<float>{   -24.2,  -21.8,  -21.5,  -22.1,  -20.3,  -20.6,  -20.3,  -20.7,  -20.2,  -20.2,  -20.6,  -20.3,  -20.5,  -20.3,  -20.4,  -20.4,  -20.5 }),
    ...
    phase::PartlyKnownLiquid {
        ...
        /*surface_tension*/        
            get_dippr_quartic_temperature_function_100
                ...
                -13.3, 25.0), 
        /*refractive_index*/       relation::spectral_constant(1.2614f),
        /*extinction_coefficient*/ relation::spectral_constant(7.63f), // Moore 2010, 95K, 5000cm-1
...
PartlyKnownCompound ethanol (
    ...
    std::vector<phase::PartlyKnownSolid> {
        phase::PartlyKnownSolid {
            ...
            /*vapor_pressure*/                    missing(),
            /*refractive_index*/                  relation::spectral_constant(1.319f), // Hudson (2020)
            /*extinction_coefficient*/            missing(),
            /*absorption_coefficient*/            missing(),
...
PartlyKnownCompound formaldehyde (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  2.51e6, 2.67e6, 2.70e6, 2.74e6, 2.83e6, 2.86e6, 2.95e6, 2.98e6, 3.06e6, 3.09e6, 3.18e6, 3.62e6, 4.02e6, 4.44e6 },
          std::vector<float>{   -26.5,  -26.1,  -25.2,  -26.1,  -23.6,  -25.4,  -23.2,  -25.0,  -23.1,  -24.5,  -23.2,  -23.6,  -24.5,  -25.7 }),
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.3714f),  // wikipedia
        /*extinction_coefficient*/ missing()
...
PartlyKnownCompound formic_acid (
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.3714f),
        /*extinction_coefficient*/ missing()
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid {
            ...
            /*refractive_index*/                  relation::spectral_constant(1.291f), // Hudson (2020)
            /*extinction_coefficient*/            missing(),
            /*absorption_coefficient*/            missing(),
...
PartlyKnownCompound perflouromethane(
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  1.28e5, 1.28e5, 1.28e5, 1.28e5, 1.28e5, 1.28e5, 1.28e5, 1.28e5, 1.28e5, 7.99e6, 8.62e6, 9.25e6, 1.00e7, 1.05e7, 1.08e7, 1.13e7, 1.20e7, 1.28e7, 1.33e7, 1.79e7, 2.14e7, 3.37e7, 5.79e7, 1.71e8 },
          std::vector<float>{  -20.19, -20.19, -19.97, -19.91, -19.92, -20.05, -20.10, -20.12, -20.17, -23.26, -23.10, -22.58, -21.35, -21.52, -20.18, -20.24, -21.06, -20.16, -20.43, -20.13, -20.31, -20.33, -20.68, -21.63 }),
    ...
    phase::PartlyKnownGas {
        ...
        /*density*/                missing(),
        /*refractive_index*/       relation::spectral_constant(1.0004823f)
    },
...
PartlyKnownCompound benzene (
    ...
    relation::get_spectral_linear_interpolation_function_of_wavenumber_for_log10_sample_output
        ( 1.0/si::meter, si::meter2,
          std::vector<float>{  3.63e6, 3.73e6, 3.75e6, 3.76e6, 3.82e6, 3.86e6, 3.87e6, 3.92e6, 3.95e6, 3.97e6, 4.03e6, 4.04e6, 4.07e6, 4.12e6, 4.14e6, 4.16e6, 4.21e6, 4.23e6, 4.25e6, 4.33e6, 4.52e6, 4.75e6, 4.91e6, 5.03e6, 5.33e6, 5.58e6, 5.85e6, 6.72e6, 7.54e6, 8.11e6, 8.79e6, 9.59e6, 1.03e7, 1.12e7, 1.41e7, 3.33e7, 2.11e8 },
          std::vector<float>{   -25.0,  -23.9,  -23.0,  -23.8,  -23.2,  -21.7,  -23.2,  -22.6,  -21.7,  -23.1,  -22.5,  -21.7,  -23.1,  -22.7,  -21.9,  -23.2,  -22.9,  -22.6,  -23.3,  -23.3,  -24.0,  -23.3,  -20.7,  -20.6,  -20.8,  -19.5,  -20.2,  -21.1,  -20.4,  -20.5,  -20.1,  -20.2,  -20.0,  -20.2,  -19.8,  -20.5,  -22.3 }),
    ...
    phase::PartlyKnownLiquid {
        ...
        /*refractive_index*/       relation::spectral_constant(1.5011),
        // field::SpectralFunction<double>([](
        //     const si::wavenumber nlo, 
        //     const si::wavenumber nhi, 
        //     const si::pressure p, 
...
PartlyKnownCompound  apatite (
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid {
            ...
            /*vapor_pressure*/                    missing(),
            /*refractive_index*/                  relation::spectral_constant(1.645f),
            /*extinction_coefficient*/            missing(),
            /*absorption_coefficient*/            missing(),
    ...
    std::vector<phase::PartlyKnownSolid>{
        ...
        phase::PartlyKnownSolid { // diamond
            ...
            /*refractive_index*/      
                relation::get_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0f,
                     std::vector<float>{0.035,  0.058,  0.058,  0.059,  0.076,  0.083,  0.084,  0.091,  0.093,  0.094,  0.095,  0.097,  0.098,  0.100,  0.102,  0.103,  0.105,  0.107,  0.109,  0.111,  0.113,  0.117,  0.122,  0.124,  0.129,  0.135,  0.148,  0.155,  0.159,  0.172,  0.177,  0.182,  0.188,  0.200,  0.230, 10.000},
                     std::vector<float>{ 0.58,   0.46,   0.46,   0.45,   0.78,   0.94,   0.97,   1.09,   1.10,   1.14,   1.21,   1.34,   1.68,   2.08,   2.55,   2.85,   3.06,   3.28,   3.44,   3.51,   3.49,   3.50,   3.45,   3.42,   3.32,   3.26,   3.22,   3.25,   3.28,   3.42,   3.28,   3.11,   2.99,   2.86,   2.69, 2.38  }),
                    // Philip (1964)
            /*extinction_coefficient*/ 
                relation::get_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0f,
                     std::vector<float>{0.035, 0.056, 0.057, 0.058, 0.058, 0.060, 0.063, 0.087, 0.090, 0.091, 0.093, 0.094, 0.095, 0.097, 0.098, 0.100, 0.102, 0.103, 0.105, 0.107, 0.109, 0.111, 0.113, 0.115, 0.117, 0.119, 0.129, 0.163, 0.168, 0.172, 0.177, 0.182,10.000},
                     std::vector<float>{0.242, 0.858, 0.956, 1.023, 1.046, 1.120, 1.241, 2.111, 2.257, 2.354, 2.466, 2.608, 2.777, 3.017, 3.372, 3.511, 3.516, 3.220, 2.970, 2.675, 2.398, 2.174, 1.919, 1.749, 1.607, 1.449, 1.071, 0.614, 0.507, 0.386, 0.088, 0.029, 0.000}),
                    // Philip (1964)
            /*absorption_coefficient*/            missing(),
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid {
            ...
            /*refractive_index*/                  
                relation::get_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0f,
                     std::vector<float>{ 0.21,  0.22,  4.18,  4.24,  4.20, 15.62, 16.13, 16.39, 16.67, 16.95, 17.24, 17.54, 17.86, 18.18, 18.52, 18.87, 19.23, 19.61, 20.00, 20.41, 20.83, 21.28, 25.00, 25.64, 26.32, 27.03, 27.78, 28.57, 29.41, 30.30, 31.25, 32.26, 33.33, 34.48, 35.71, 37.04, 38.46, 40.00, 41.67, 43.48, 47.62, 50.00, 52.63, 55.56},
                     std::vector<float>{2.3, 2.3, 3.3, 3.3, 3.3, 3.5, 3.5, 3.5, 3.5, 3.5, 3.8, 4.4, 5.1, 5.3, 5.1, 4.9, 4.7, 4.6, 4.5, 4.5, 4.4, 4.4, 4.4, 4.4, 4.5, 4.7, 5.2, 6.3, 7.4, 7.3, 6.9, 6.6, 6.4, 6.3, 6.3, 6.4, 6.4, 6.5, 6.7, 6.7, 7.1, 7.3, 7.7, 7.9}),
                    // Querry (1985)
            /*extinction_coefficient*/            
                relation::get_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0f,
                     std::vector<float>{ 0.21,  0.22,  2.83,  2.96,  9.90, 15.38, 15.62, 16.13, 16.39, 16.67, 16.95, 17.24, 17.54, 17.86, 18.18, 18.52, 18.87, 19.23, 19.61, 20.00, 20.41, 23.26, 23.81, 24.39, 25.00, 25.64, 26.32, 27.03, 27.78, 28.57, 29.41, 30.30, 31.25, 32.26, 33.33, 34.48, 35.71, 37.04, 38.46, 40.00, 41.67, 43.48, 45.45, 47.62, 50.00, 52.63, 55.56},
                     std::vector<float>{0.085, 0.109, 1.194, 1.180, 1.464, 2.348, 2.427, 2.626, 2.761, 2.963, 3.249, 3.642, 3.907, 3.604, 2.966, 2.540, 2.383, 2.348, 2.365, 2.402, 2.460, 2.959, 3.078, 3.224, 3.413, 3.655, 3.958, 4.392, 4.940, 5.210, 4.290, 3.268, 2.855, 2.776, 2.807, 2.858, 2.950, 3.017, 3.058, 3.185, 3.226, 3.253, 3.357, 3.331, 3.400, 3.351, 3.209}),
                    // Querry (1985)
            /*absorption_coefficient*/            
                relation::get_absorption_coefficient_function_from_reflectance_at_wavelengths // for magnetite
                    (si::micrometer,  233.0 *si::micrometer, 
                    std::vector<float>{  0.242,  0.257,  0.273,  0.301,  0.333,  0.392,  0.469,  0.555,  0.600,  0.703,  1.009,  1.111,  1.271,  1.755,  1.887,  1.914,  2.000,  2.019,  2.138,  2.442,  2.465,  2.496,  2.561,  2.595,  2.652,  2.720,  2.755,  2.779,  2.846,  2.882,  2.912,  2.980,  4.870, 13.431, 15.719, 16.678, 17.785, 18.745, 20.000, 22.361, 24.059, 28.929, 30.996, 32.915, 33.800, 38.671, 39.704, 40.811, 42.878, 44.428, 46.346, 55.424, 57.490, 62.287, 66.346, 70.258, 72.988, 84.575, 89.889,101.107,109.594,119.926,126.568 },
                    std::vector<float>{  0.052,  0.051,  0.058,  0.056,  0.059,  0.061,  0.057,  0.057,  0.058,  0.057,  0.044,  0.044,  0.048,  0.071,  0.075,  0.073,  0.079,  0.077,  0.081,  0.086,  0.084,  0.087,  0.086,  0.089,  0.087,  0.095,  0.081,  0.088,  0.090,  0.090,  0.102,  0.080,  0.110,  0.141,  0.164,  0.182,  0.222,  0.180,  0.175,  0.179,  0.186,  0.305,  0.270,  0.268,  0.277,  0.303,  0.300,  0.303,  0.319,  0.310,  0.324,  0.321,  0.315,  0.329,  0.315,  0.330,  0.321,  0.323,  0.340,  0.324,  0.332,  0.331,  0.324 }),
...
PartlyKnownCompound  chalcopyrite (
    ...
    std::vector<phase::PartlyKnownSolid>{
        phase::PartlyKnownSolid {
            ...
            /*extinction_coefficient*/            missing(),
            /*absorption_coefficient*/            
                relation::get_absorption_coefficient_function_from_reflectance_at_wavelengths // for chalcopyrite
                    (si::micrometer,  162 *si::micrometer, 
                    std::vector<float>{ 0.235, 0.246, 0.315, 0.342, 0.382, 0.406, 0.428, 0.546, 0.585, 0.700, 0.824, 0.840, 0.902, 0.951, 1.147, 1.459, 1.618, 1.656, 1.941, 2.423, 2.465, 2.527, 2.589, 2.750, 2.786, 2.812, 2.842, 2.883, 2.910, 2.942, 2.979, 3.512, 3.806, 5.509, 6.126, 6.233, 6.501, 6.675, 6.863, 7.627, 7.949, 8.190, 8.565, 8.686, 9.410, 9.651, 9.772,10.415,10.831,13.176,13.458,14.383,15.335,15.911,16.099,18.069,18.860,19.195,19.705,19.919,20.093,20.482,21.179,21.434,22.050,22.144,23.391,23.592,24.008,24.262,24.450,24.691 },
                    std::vector<float>{ 0.020, 0.031, 0.033, 0.027, 0.024, 0.026, 0.031, 0.084, 0.092, 0.099, 0.096, 0.094, 0.097, 0.098, 0.107, 0.109, 0.106, 0.107, 0.101, 0.103, 0.102, 0.104, 0.102, 0.103, 0.093, 0.103, 0.102, 0.114, 0.109, 0.110, 0.101, 0.111, 0.113, 0.119, 0.120, 0.121, 0.122, 0.122, 0.124, 0.126, 0.128, 0.124, 0.125, 0.127, 0.120, 0.120, 0.122, 0.122, 0.123, 0.123, 0.122, 0.123, 0.121, 0.121, 0.122, 0.121, 0.119, 0.117, 0.121, 0.119, 0.122, 0.118, 0.117, 0.118, 0.113, 0.114, 0.109, 0.107, 0.109, 0.107, 0.107, 0.105 }),

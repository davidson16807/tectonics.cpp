            ...
            /*isobaric_specific_heat_capacity*/   // 750.0*si::joule/(si::kilogram* si::kelvin)
                get_perry_johnson_temperature_function
                    (si::kelvin, 
                     ...
                     273.0, 1973.0), 
            /*thermal_conductivity*/              // field::StateSample<si::thermal_conductivity<double>>(37.0*si::watt/(si::meter * si::kelvin), si::atmosphere, 20.0*si::celcius),//azom.com/article.aspx?ArticleId=1948
                get_interpolated_temperature_function
                    (si::kelvin, si::watt / (si::meter * si::kelvin),

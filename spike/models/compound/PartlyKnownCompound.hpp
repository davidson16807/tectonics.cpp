...
namespace compound
{
    ...
    */
    struct PartlyKnownCompound
    {
        ...
        relation::OptionalStateRelation<relation::SplineRelation<si::wavenumber, si::area, 0, 1>> molecular_absorption_cross_section;
        ...
        PartlyKnownCompound(
            ...
            const relation::OptionalStateRelation<relation::SplineRelation<si::wavenumber, si::area, 0, 1>> molecular_absorption_cross_section,

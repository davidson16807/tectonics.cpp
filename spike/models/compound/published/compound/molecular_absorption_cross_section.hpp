...
namespace published { 
    ...
    table::PartialTable<relation::PolynomialRailyardRelation<si::wavenumber<double>,si::area<double>,0,1>>  molecular_absorption_cross_section {
        ...
        {ids::argon, 1e-35*si::meter2,
            
                },
        {ids::helium, 1e-35* si::meter2,
        ...
        {ids::formic_acid, missing(),
            
                },
        {ids::perflouromethanemissing,(),
        ...
        {ids::orthoclase, missing(),
            
                },
        {ids::andesine, missing(),
            
                },
        {ids::augite, missing(),
            
                },
        {ids::forsterite, missing(),
            
                },
        {ids::goethite, missing(),
            
                },
        {ids::pyrite, missing(),
            
                },
        {ids::hematite, missing(),
        ...
        {ids::magnetite, missing(),
            
                },
        {ids::chalcocite, missing(),
            
                },
        {ids::chalcopyrite, missing(),

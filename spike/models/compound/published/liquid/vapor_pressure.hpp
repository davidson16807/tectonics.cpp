...
namespace published { 
    ...
    using LiquidVaporPressureTemperatureRelation = relation::LiquidVaporPressureTemperatureRelation;
    table::PartialTable<LiquidVaporPressureTemperatureRelation> vapor_pressure_as_liquid {
        { ids::water,         
                ...
                // }),
                relation::get_dippr_vapor_pressure_temperature_relation_101
                    (si::kelvin, si::pascal,
                     73.649, -7258.2, -7.3037, 4.1653e-6, 2,
                      273.16, 647.1f),//273.16-647.1K
            },
        { ids::nitrogen,         
                relation::get_dippr_vapor_pressure_temperature_relation_101
                    (si::kelvin, si::pascal,
                     58.282, -1084.1, -8.3144, 0.044127, 1,
                      63.15, 126.2f), // 63.15-126.2K
            },
        { ids::oxygen,         
                relation::get_dippr_vapor_pressure_temperature_relation_101
                    (si::kelvin, si::pascal,
                     51.245, -1200.2, -6.4361, 0.028405, 1,
                      54.36, 154.58f), // 54.36-154.58K
            },
        { ids::carbon_dioxide,         
                relation::get_dippr_vapor_pressure_temperature_relation_101
                    (si::kelvin, si::pascal,
                     47.0169, -2839.0, -3.86388, 2.81e-16, 6,
                      216.58, 304.21f), // 216.58-304.21K
            },
        { ids::methane,         
                relation::get_dippr_vapor_pressure_temperature_relation_101
                    (si::kelvin, si::pascal,
                     39.205, -1324.4, -3.4366, 0.000031019, 2,
                      90.69, 190.56f), // 90.69-190.56K
            },
        { ids::argon,         
                relation::get_dippr_vapor_pressure_temperature_relation_101
                    (si::kelvin, si::pascal,
                     42.127, -1093.1, -4.1425, 0.000057254, 2,
                      83.78, 150.86f), // 83.78-150.86K
            },
        { ids::helium,         
                relation::get_dippr_vapor_pressure_temperature_relation_101
                    (si::kelvin, si::pascal,

...
namespace published { 
    ...
    table::PartialTable<relation::AnonymousTemperatureRelation<si::surface_energy<double>>> surface_tension_as_liquid {
        { ids::water,            
        ...
        { ids::ozone,        38.1 * si::dyne/si::centimeter, // -182.7C, Jasper (1972)
            },
        { ids::nitrous_oxide,        
                relation::get_refprop_liquid_surface_tension_temperature_relation
                    (si::kelvin, si::newton/si::meter,
        ...
        { ids::formaldehyde,        27.3797 * si::dyne/si::centimeter, // 25 °C, PubChem
            },
        { ids::formic_acid,        
                relation::get_linear_interpolation_anonymous_temperature_relation
        ...
        { ids::quartz,                 312.0 * si::dyne / si::centimeter, // 1400C, Shartsis (1951)
            },
        { ids::halite,        
                relation::get_linear_interpolation_anonymous_temperature_relation
                    (si::celcius, si::dyne/si::centimeter,

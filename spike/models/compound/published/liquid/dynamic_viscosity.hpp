...
namespace published { 
    ...
    using LiquidDynamicViscosityTemperatureRelation = relation::LiquidDynamicViscosityTemperatureRelation;
    table::PartialTable<LiquidDynamicViscosityTemperatureRelation> dynamic_viscosity_as_liquid {
        { ids::water,      
                relation::get_dippr_dynamic_viscosity_temperature_relation_101

...
namespace published { 
    ...
    using SolidTensileModulusTemperatureRelation = relation::Relation<si::temperature<double>,si::pressure<double>, math::PolynomialRailyard<float,0,1>>;
    std::map<int, SolidTensileModulusTemperatureRelation> tensile_modulus_as_solid {

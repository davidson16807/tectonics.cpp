...
namespace published { 
    ...
    using SolidExtinctionCoefficientWavenumberRelation = relation::AnonymousRelation<si::wavenumber<double>,double>;
    table::PartialTable<SolidExtinctionCoefficientWavenumberRelation> extinction_coefficient_as_solid {
        { ids::water, 
                relation::get_anonymous_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0,
        ...
        { ids::methane,            
                relation::get_anonymous_spectral_linear_interpolation_function_of_wavenumber

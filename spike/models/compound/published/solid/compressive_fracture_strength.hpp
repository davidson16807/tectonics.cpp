...
namespace published { 
    ...
    using SolidCompressiveFractureStrengthTemperatureRelation = relation::Relation<si::temperature<double>,si::pressure<double>, math::PolynomialRailyard<float,0,1>>;
    std::map<int, SolidCompressiveFractureStrengthTemperatureRelation> compressive_fracture_strength_as_solid {

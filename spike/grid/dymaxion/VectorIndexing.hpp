...
namespace dymaxion
{
    ...
    */
    ...
    class Vector2Indexing
    {
        ...
        const bijective::Interleaving<id> interleave;

    public:
        const id vertex_count_per_side;
        const id vertex_count;

        constexpr Vector2Indexing(const id vertex_count_per_side) : 
            interleave(vertex_count_per_side),
            vertex_count_per_side(vertex_count_per_side),
            vertex_count(vertex_count_per_side*vertex_count_per_side)
        {
        }

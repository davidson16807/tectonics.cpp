...
TEST_CASE( "Interleaving.interleaved_id()", "[bijective]" ) {
    bijective::Interleaving interleaving(10);
    ...
    REQUIRE(test::determinism(exact,
        "Interleaving.interleaved_id(…)", TEST_BINARY(bijective::Interleaving(10).interleaved_id), 
        ordinates, ordinates
    ));

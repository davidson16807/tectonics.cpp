...
namespace data
{
	...
	inline auto mod(const T1 a, const T2 b)
	{
	...
	template <typename T>
	inline auto mix(const T x, const T y, const T a)
	{
	...
	template <typename T>
	inline auto step(const T edge, const T x, const T out)
	{

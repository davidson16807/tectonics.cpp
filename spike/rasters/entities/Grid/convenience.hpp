...
namespace rasters
{
	...
	template<class Tgrid, rasters::mapping Tmap, class T1, class T2, typename F, 
		std::enable_if_t<!std::is_base_of<each::AbstractSeries, F>::value, int> = 0>
	...
	template<class Tgrid, rasters::mapping Tmap, class T1, class T2, typename F, 
		std::enable_if_t<!std::is_base_of<each::AbstractSeries, T2>::value && !std::is_base_of<each::AbstractSeries, F>::value, int> = 0>
	...
	template<class Tgrid, rasters::mapping Tmap, class T1, class T2, typename F, 
		std::enable_if_t<!std::is_base_of<each::AbstractSeries, T1>::value && !std::is_base_of<each::AbstractSeries, F>::value, int> = 0>
	...
	template<class Tgrid, rasters::mapping Tmap, class T1, class T2, class T3, typename F, 
		std::enable_if_t<!std::is_base_of<each::AbstractSeries, T3>::value && !std::is_base_of<each::AbstractSeries, F>::value, int> = 0>
	...
	template<class Tgrid, rasters::mapping Tmap, class T1, class T2, class T3, typename F,
		std::enable_if_t<!std::is_base_of<each::AbstractSeries, T2>::value && !std::is_base_of<each::AbstractSeries, T3>::value && !std::is_base_of<each::AbstractSeries, F>::value, int> = 0>
	...
	template<class Tgrid, rasters::mapping Tmap, class T1, class T2, class T3, typename F,
		std::enable_if_t<!std::is_base_of<each::AbstractSeries, T1>::value && !std::is_base_of<each::AbstractSeries, T3>::value && !std::is_base_of<each::AbstractSeries, F>::value, int> = 0>
	...
	template<class Tgrid, rasters::mapping Tmap, class T1, class T2, class T3, typename F,
		std::enable_if_t<!std::is_base_of<each::AbstractSeries, T1>::value && !std::is_base_of<each::AbstractSeries, T2>::value && !std::is_base_of<each::AbstractSeries, F>::value, int> = 0>
	...
	{
		Raster<T,Tgrid,Tmap> group_out = Raster<T,Tgrid,Tmap>(each::max(group_ids));

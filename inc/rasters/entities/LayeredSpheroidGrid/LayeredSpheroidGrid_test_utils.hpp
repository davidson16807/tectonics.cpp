...
rasters::LayeredSpheroidGrid<uint,float> layered_octahedron_grid(octahedron_grid, 1.0f, 0.0f, 2u);

rasters::LayeredSpheroidGrid<uint,float> layered_icosahedron_grid(icosahedron_grid, 1.0f, 0.0f, 2u);

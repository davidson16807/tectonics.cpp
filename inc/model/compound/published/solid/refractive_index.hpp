...
namespace published { 
    ...
    table::PartialTable<SolidRefractiveIndexWavenumberRelation> refractive_index_as_solid {
        ...
        { polymorphs::nitrogen_ice_beta,         1.25, // wikipedia
            },
        ...
        { polymorphs::methane_ice_alpha,         1.3219,
            },
        // { polymorphs::methane_ice_beta,          },
        // { polymorphs::methane_ice_beta,          },
        { polymorphs::argon_ice,                 1.2703,
            },
        ...
        //     // }), // Peck & Hung (1977)
        //     // }
        { polymorphs::ammonia_ice,               1.5,
            },
        // { polymorphs::ozone_ice,                 },
        { polymorphs::nitrous_oxide_ice,         1.317, // Hudson (2020)
            },
        ...
        { polymorphs::hydrogen_cyanide_ice,      1.37,    // Moore 2010, 95K 5000 cm-1
            },
        { polymorphs::ethanol_ice,               1.319, // Hudson (2020)
            },
        // { polymorphs::formaldehyde_ice,          },
        { polymorphs::formic_acid_ice,           1.291, // Hudson (2020)
            },
        ...
        { polymorphs::diamond,                   
                relation::get_generic_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0,
                     std::vector<double>{0.035,  0.058,  0.059,  0.076,  0.083,  0.084,  0.091,  0.093,  0.094,  0.095,  0.097,  0.098,  0.100,  0.102,  0.103,  0.105,  0.107,  0.109,  0.111,  0.113,  0.117,  0.122,  0.124,  0.129,  0.135,  0.148,  0.155,  0.159,  0.172,  0.177,  0.182,  0.188,  0.200,  0.230, 10.000},
                     std::vector<double>{ 0.58,   0.46,   0.45,   0.78,   0.94,   0.97,   1.09,   1.10,   1.14,   1.21,   1.34,   1.68,   2.08,   2.55,   2.85,   3.06,   3.28,   3.44,   3.51,   3.49,   3.50,   3.45,   3.42,   3.32,   3.26,   3.22,   3.25,   3.28,   3.42,   3.28,   3.11,   2.99,   2.86,   2.69, 2.38  }),
                    // Philip (1964)
            },
        // { polymorphs::calcite,                   },
        ...
        { polymorphs::orthoclase,              1.527,
            },
        { polymorphs::andesine,                1.553,
            },
        { polymorphs::augite,                  1.707,
            },
        { polymorphs::forsterite,              1.651,
            },
        { polymorphs::goethite,                2.401,
            },
        { polymorphs::pyrite,                  1.78, //gemologyproject.com
            },
        { polymorphs::hematite,                  
                relation::get_generic_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0,

...
maybe_float_pair get_distances_along_line_to_intersection(
    ...
    return maybe_float_pair(first, last, shape1.exists && shape2.exists && first < last);
}
...
maybe_float_pair get_distances_along_2d_line_to_circle(
    in vec2 A0,
    in vec2 A,
    in vec2 B0,
    in float r
    ...
    return maybe_float_pair(xz - dxr, xz + dxr, y2 > 0.);
}
...
maybe_float_pair get_distances_along_2d_line_to_triangle(
    in vec2 A0,
    in vec2 A,
    in vec2 B1,
    in vec2 B2,
    ...
    return maybe_float_pair(
        min(line1.value, min(line2.value, line3.value)), 
...
maybe_float_pair get_distances_along_3d_line_to_infinite_cylinder(
    in vec3 A0,
    in vec3 A,
    in vec3 B0,
    in vec3 B,
...
maybe_float_pair get_distances_along_3d_line_to_cylinder(
    in vec3 A0,
    in vec3 A,
    in vec3 B1,
    in vec3 B2,
...
maybe_float_pair get_distances_along_3d_line_to_capsule(
    in vec3 A0,
    in vec3 A,
    in vec3 B1,
    in vec3 B2,
    ...
    maybe_float_pair cylinder = get_distances_along_3d_line_to_cylinder(A0, A, B1, B2, r);
    maybe_float_pair sphere1 = get_distances_along_3d_line_to_sphere(A0, A, B1, r);
    maybe_float_pair sphere2 = get_distances_along_3d_line_to_sphere(A0, A, B2, r);
    maybe_float_pair spheres = get_distances_along_line_to_union(sphere1, sphere2);
    maybe_float_pair capsule = get_distances_along_line_to_union(spheres, cylinder);
    return capsule;
}
...
maybe_float_pair get_distances_along_3d_line_to_ring(
    in vec3 A0,
    in vec3 A,
    in vec3 B1,
    in vec3 B2,
    ...
    maybe_float_pair outer = get_distances_along_3d_line_to_cylinder(A0, A, B1, B2, ro);
    maybe_float_pair inner = get_distances_along_3d_line_to_cylinder(A0, A, B1, B2, ri);
    maybe_float_pair ring  = get_distances_along_line_to_negation(outer, inner);
    return ring;
}

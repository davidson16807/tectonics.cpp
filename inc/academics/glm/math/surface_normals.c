...
r  radius
*/
vec3 get_surface_normal_of_point_on_sphere( in vec3 A0, in vec3 B0, in float r )
{
...
R  radius
*/
vec3 get_surface_normal_of_point_on_ellipsoid( in vec3 A0, in vec3 B0, in vec3 R )
{
    return normalize( (A0-B0)/R );
}
/*
A0 point position
...
*/
vec3 get_surface_normal_of_point_on_cylinder( in vec3 A0, in vec3 B1, in vec3 B2 )
{
    vec3 D = A0-B1;

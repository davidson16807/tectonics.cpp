...
namespace published { 
    ...
    table::PartialTable<SolidTensileYieldStrengthTemperatureRelation> tensile_yield_strength_as_solid {
        { compounds::water,               1.0 * si::megapascal,                             // brittle, effectively the same as fracture strength
            },
        { compounds::nitrogen,            
        ...
        { compounds::quartz,              48.0 * si::megapascal, // https://material-properties.org/strength-of-materials-tensile-yield/
            },
        { compounds::halite,              1.65 * si::megapascal, // https://material-properties.org/strength-of-materials-tensile-yield/
            },
        // { compounds::corundum,         },
        // { compounds::apatite,          },
        { compounds::carbon,              14.0 * si::megapascal, // https://material-properties.org/strength-of-materials-tensile-yield/
            },
        // { compounds::calcite,          },
        ...
        // { compounds::pyrite,           },
        // { compounds::hematite,         },
        { compounds::gold,                300.0 * si::megapascal, // https://material-properties.org/strength-of-materials-tensile-yield/
            },
        // { compounds::silver,           },
        { compounds::copper,              70.0 * si::megapascal, // engineering toolbox
            },
        // { compounds::magnetite,        },

...
namespace published { 
    ...
    table::PartialTable<SolidRefractiveIndexWavenumberRelation> refractive_index_as_solid {
        ...
        { compounds::nitrogen,                1.25, // wikipedia
            },
        // { compounds::oxygen,           },
        ...
        { compounds::methane,                 1.3219,
            },
        { compounds::argon,                   1.2703,
            },
        // // { compounds::helium,                    
        ...
        //     // }), // Peck & Hung (1977)
        //     // }
        { compounds::ammonia,                 1.5,
            },
        // { compounds::ozone,            },
        { compounds::nitrous_oxide,           1.317, // Hudson (2020)
            },
        // { compounds::sulfur_dioxide,   },
        // { compounds::nitric_oxide,     },
        // { compounds::carbon_monoxide,  },
        // { compounds::ethane,           },
        { compounds::hydrogen_cyanide,        1.37,    // Moore 2010, 95K 5000 cm-1
            },
        { compounds::ethanol,                 1.319, // Hudson (2020)
            },
        // { compounds::formaldehyde,     },
        { compounds::formic_acid,             1.291, // Hudson (2020)
            },
        ...
        //         }),
        //     },
        { compounds::orthoclase,              1.527,
            },
        { compounds::andesine,                1.553,
            },
        { compounds::augite,                  1.707,
            },
        { compounds::forsterite,              1.651,
            },
        { compounds::goethite,                2.401,
            },
        { compounds::pyrite,                  1.78, //gemologyproject.com
            },
        { compounds::hematite,                  
                relation::get_generic_spectral_linear_interpolation_function_of_wavelength
                    (si::micrometer, 1.0,

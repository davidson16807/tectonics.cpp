...
namespace published { 
    ...
    table::PartialTable<SolidShearModulusTemperatureRelation> shear_modulus_as_solid {
        { compounds::water,               3.521 * si::gigapascal,                           // gammon (1983)
            },
        { compounds::nitrogen,                     
        ...
        { compounds::methane,             12.4*si::kilobar, // Prokhvatilov, @ si::standard_pressure, 14.4*si::kelvin
            },
        { compounds::argon,                     
                relation::get_linear_interpolation_function
                    (si::kelvin, si::kilobar,
        ...
        { compounds::quartz,              0.5820e11*si::pascal, 
            },
        { compounds::halite,              14.9 * si::gigapascal, // 0.1287e11*si::pascal, // values from Perry produce negative bulk modulus so they are commented out
            },
        { compounds::corundum,            162.1 * si::gigapascal, // Mavko (2009)
            },
        // { compounds::apatite,          },
        // { compounds::carbon,           },
        { compounds::calcite,             32.0 * si::gigapascal, // Schön (2015) 
            },
        { compounds::orthoclase,          27.3 * si::gigapascal, // Schön (2015)
            },
        { compounds::andesine,            40.0 * si::gigapascal, // Schön (2015), for anorthite
            },
        { compounds::augite,              57.0*si::gigapascal, // Schön (2015)
            },
        { compounds::forsterite,          0.6515e11*si::pascal,
            },
        // { compounds::goethite,         },
        { compounds::pyrite,              1.094e11*si::pascal,
            },
        { compounds::hematite,            0.8569e11*si::pascal, 
            },
        { compounds::gold,                ((26.0+30.0)/2.0*si::gigapascal), // https://www.azom.com/properties.aspx?ArticleID=598 0.4200e11*si::pascal,    // values from Perry produce negative bulk modulus so they are commented out
            },
        { compounds::silver,              0.4612e11*si::pascal,
            },
        { compounds::copper,              0.757e11*si::pascal,
            },
        { compounds::magnetite,           0.971e11*si::pascal,
            },

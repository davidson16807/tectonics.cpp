...
namespace many
{
	...
	template <typename T>
	std::string to_string(const std::vector<T>& a, const T lo, const T hi, const int line_char_width = 80)
	{
		std::string out("");
	...
	template <typename T>
	std::string to_string(const std::vector<T>& a, const int line_char_width = 80)
	{

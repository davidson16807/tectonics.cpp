...
TEST_CASE( "ArbitraryDegreeRational arithmetic identity", "[math]" ) {
    ...
    auto zero = analytic::ArbitraryDegreeRational<double,std::int8_t>(analytic::Polynomial<double,0,0>{0.0f}, analytic::Polynomial<double,0,0>{1.0});
    auto one  = analytic::ArbitraryDegreeRational<double,std::int8_t>(analytic::Polynomial<double,0,0>{1.0}, analytic::Polynomial<double,0,0>{1.0});

...
TEST_CASE( "RationalRailyard arithmetic purity", "[math]" ) {
...
TEST_CASE( "RationalRailyard arithmetic identity", "[math]" ) {
...
TEST_CASE( "RationalRailyard arithmetic commutativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    // `mid*` variables are used when the degree of a polynomial is so large 
    // that a square integral of it will produce nans for all but the smallest input.
    const double lo = -1000.0f;
...
TEST_CASE( "RationalRailyard arithmetic associativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    // `mid*` variables are used when the degree of a polynomial is so large 
    // that a square integral of it will produce nans for all but the smallest input.
...
TEST_CASE( "RationalRailyard arithmetic distributivity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    // `mid*` variables are used when the degree of a polynomial is so large 
    // that a square integral of it will produce nans for all but the smallest input.
    const double midlo = -3.0f;
...
TEST_CASE( "RationalRailyard/scalar arithmetic purity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
...
TEST_CASE( "RationalRailyard/scalar arithmetic identity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
...
TEST_CASE( "RationalRailyard/scalar arithmetic commutativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/scalar arithmetic associativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/scalar arithmetic distributivity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    // `mid*` variables are used when the degree of a polynomial is so large 
    // that a square integral of it will produce nans for all but the smallest input.
    const double lo = -1000.0f;
...
TEST_CASE( "RationalRailyard/monomial arithmetic purity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    // `mid*` variables are used when the degree of a polynomial is so large 
    // that a square integral of it will produce nans for all but the smallest input.
    const double lo = -30.0f;
...
TEST_CASE( "RationalRailyard/monomial arithmetic identity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
...
TEST_CASE( "RationalRailyard/monomial arithmetic commutativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    // `mid*` variables are used when the degree of a polynomial is so large 
    // that a square integral of it will produce nans for all but the smallest input.
    const double lo = -1000.0f;
...
TEST_CASE( "RationalRailyard/monomial arithmetic associativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/monomial arithmetic distributivity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    // `mid*` variables are used when the degree of a polynomial is so large 
    // that a square integral of it will produce nans for all but the smallest input.
    const double midlo = -3.0f;
...
TEST_CASE( "RationalRailyard/Shifting arithmetic purity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/Shifting arithmetic commutativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/Shifting arithmetic associativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/Shifting arithmetic distributivity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/Scaling arithmetic purity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/Scaling arithmetic identity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
...
TEST_CASE( "RationalRailyard/Scaling arithmetic commutativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/Scaling arithmetic associativity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    const double lo = -1000.0f;
    const double hi =  1000.0f;
    const double midlo = -100.0f;
...
TEST_CASE( "RationalRailyard/Scaling arithmetic distributivity", "[math]" ) {
    const double threshold = std::numeric_limits<double>::epsilon();
    // `mid*` variables are used when the degree of a polynomial is so large 
    // that a square integral of it will produce nans for all but the smallest input.
    const double lo = -1000.0f;

...
/*
"Sea" is a data structure that holds the mass pools of all liquids found on or within a world.
This includes the oceans of Earth, the lakes of Titan, the lava oceans of hadean Earth,
 and the liquid mantles of most planets.
...
var Sea = (function() {
    ...
    */
    ...
    const molecular_masses = {
        ...
        mass_orthoclase : 278.33 * units::dalton, 
        mass_olivine    : 153.31 * units::dalton, 
    ...
    const liquid_densities = {
        ...
        mass_orthoclase : 2180, // from Murase and McBirney (1973), for rhyolitic magma
        mass_olivine    : 2800, // from Murase and McBirney (1973), for basaltic  magma
        mass_Fe         : 7874,
    };
    /*
    ...
    */
    const molecular_refractions = {
        ...
        mass_orthoclase : get_molecular_refraction_of_refractive_index_at_stp(1.003000), // WARNING: wild ass guess based on correlation with molar mass
        mass_olivine    : get_molecular_refraction_of_refractive_index_at_stp(1.001500), // WARNING: wild ass guess based on correlation with molar mass
    ...
    const molecular_diameters = {
        ...
        mass_orthoclase :3000 * units::picometer, // WARNING: wild ass guess based on correlation with molar mass
        mass_olivine    :1500 * units::picometer, // WARNING: wild ass guess based on correlation with molar mass

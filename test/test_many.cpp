...
TEST_CASE( "many arithmetic consistency", "[many]" ) {
...
TEST_CASE( "many arithmetic purity", "[many]" ) {
...
TEST_CASE( "many arithmetic identity", "[many]" ) {
    floats a = floats({1,2,3,4,5});
...
TEST_CASE( "many arithmetic commutativity", "[many]" ) {
    floats a = floats({1,2,3,4,5});
    floats b = floats({-1,1,-2,2,3});
...
TEST_CASE( "many arithmetic associativity", "[many]" ) {
    floats a = floats({1,2,3,4,5});
    floats b = floats({-1,1,-2,2,3});
...
TEST_CASE( "many arithmetic distributivity", "[many]" ) {
    floats a = floats({1,2,3,4,5});
    floats b = floats({-1,1,-2,2,3});
    floats c = floats({1,1,2,3,5});
...
TEST_CASE( "many min/max purity", "[many]" ) {
    floats a = floats({1,2,3,4,5});
...
TEST_CASE( "many min/max associativity", "[many]" ) {
    floats a = floats({1,2,3,4,5});
    floats b = floats({-1,1,-2,2,3});
    floats c = floats({1,1,2,3,5});
...
TEST_CASE( "many comparator purity", "[many]" ) {
    floats a = floats({1,2,3,4,5});
    floats b = floats({1,1,2,3,5});
...
TEST_CASE( "many comparator consistency", "[many]" ) {
    floats a    = floats({1,2,3,4,5});
    floats b    = floats({1,1,2,3,5});
...
TEST_CASE( "many sqrt purity", "[many]" ) {
    floats a = floats({1,2,3,4,5});
    floats c1 = floats({0,0,0,0,0});
    floats c2 = floats({0,0,0,0,0});
...
TEST_CASE( "many sqrt consistency", "[many]" ) {
    floats a     = floats({1,2,3,4,5});
    floats b     = floats({1,1,2,3,5});
...
TEST_CASE( "many log consistency", "[many]" ) {
    floats a     = floats({1,2,3,4,5});
    floats b     = floats({1,1,2,3,5});
    floats log1_ = floats({0,0,0,0,0});
    floats log2_ = floats({0,0,0,0,0});
